<h2><a href="https://leetcode.com/problems/reverse-nodes-in-even-length-groups/?envType=problem-list-v2&envId=linked-list">2074. Reverse Nodes in Even Length Groups</a></h2><h3>Medium</h3><hr><p>You are given the <code>head</code> of a linked list.</p>
