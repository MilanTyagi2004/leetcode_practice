<h2><a href="https://leetcode.com/problems/erect-the-fence/?envType=problem-list-v2&envId=math">587. Erect the Fence</a></h2><h3>Hard</h3><hr><p>You are given an array <code>trees</code> where <code>trees[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents the location of a tree in the garden.</p>
